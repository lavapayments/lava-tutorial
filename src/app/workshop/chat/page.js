...
export default function WorkshopChat() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/workshop/chat', {
        method: 'POST',
    ...
    <>
      ...
      <div className="text-center py-4 border-b border-gray-800">
        ...
        <p className="text-gray-400 mt-2">
          Build a monetized AI chat app with any LLM through Lava Build
        </p>
        <p className="text-sm text-gray-500 mt-1">
          Complete src/app/api/workshop/chat/route.js to implement AI chat with Lava.
        </p>
      </div>
