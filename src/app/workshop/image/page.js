...
export default function WorkshopVision() {
  ...
  const handleAnalyze = async (e) => {
    ...
    try {
      const response = await fetch('/api/workshop/image', {
        method: 'POST',
    ...
    <>
      ...
      <div className="text-center py-4 border-b border-gray-800">
        ...
        <p className="text-gray-400 mt-2">
          Analyze images with AI vision through Lava Build
        </p>
        <p className="text-sm text-gray-500 mt-1">
          Complete src/app/api/workshop/image/route.js to implement image analysis
        </p>
      </div>
        ...
        <div className="flex-1 px-2 ">
          ...
          {isLoading && (
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
              <p className="text-gray-400 text-center">Analyzing image...</p>
            </div>
          )}
          ...
          {!analysis && !isLoading && !imageUrl && (
            <div className="text-center text-gray-400 mt-12">
              <p className="text-xl">Welcome to the Image Analyzer!</p>
              <p className="mt-2">Enter an image URL to get AI-powered scene analysis.</p>
