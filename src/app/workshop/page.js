  ...
  return (
    <div className="flex flex-col h-screen max-w-4xl mx-auto p-4 bg-black">
      ...
      <div className="text-center py-6 border-b border-gray-800">
        ...
        <h1 className="text-3xl font-bold text-white">Workshop Chat</h1>
        <p className="text-gray-400 mt-2">
          Build a monetized AI chat app. 
        </p>
        <p className="text-sm text-gray-500 mt-1">
        Make sure to create a <a href="https://www.lavapayments.com/sign-up" target="_blank" rel="noopener noreferrer" className="text-[#ff5a1f] hover:text-[#e64f1a] transition-colors">Lava account</a> to get your API key.
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto py-6 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center text-gray-400 mt-12">
            <p className="text-xl">Welcome to the workshop!</p>
            <p className="mt-2">Start chatting to test your implementation.</p>
            <p className="mt-4 text-sm">
              Complete src/app/api/workshop/route.js to implement AI chat with Lava.
            </p>
          </div>
        ) : (
